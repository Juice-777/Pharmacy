...
namespace Apteka {
    ...
    public partial class PharmacyDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Name, string Password) {
...
namespace Apteka.PharmacyDBDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Password]) VALUES (@Name, @Password);\r\nSELECT" +
                " Id, Name, Password FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Name] = @Name, [Password] = @Password WHERE (([Id] = @O" +
                "riginal_Id) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password))" +
                ";\r\nSELECT Id, Name, Password FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Apteka.Properties.Settings.Default.PharmacyDB_Users;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Password FROM dbo.[Table]";
        ...
        public virtual int Fill(PharmacyDBDataSet.TableDataTable dataTable) {
        ...
        public virtual PharmacyDBDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PharmacyDBDataSet.TableDataTable dataTable = new PharmacyDBDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PharmacyDBDataSet.TableDataTable dataTable) {
